...
export default function income() {
  ...
  const getList = () => {
    setIsLoading(true);
    Promise.all([axios.get('http://192.168.1.6:3000/list?type=0'),
      axios.get('http://192.168.1.6:3000/list/lastMonths?type=0&month=5'),
      axios.get('http://192.168.1.6:3000/list/lastMonths?type=0&month=0')]).then(values => {
